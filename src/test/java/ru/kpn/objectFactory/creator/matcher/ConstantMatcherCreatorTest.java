...
public class ConstantMatcherCreatorTest {
    ...
    private static final String KEY = ConstantMatcherCreator.class.getSimpleName();
    ...
    void shouldCheckCreationAttemptWhenDatumConstantIsNull() {
        final Seed<String> expectedStatus = USeedBuilderService.takeNew().code("datum.constant.isNull").arg(KEY).build();
